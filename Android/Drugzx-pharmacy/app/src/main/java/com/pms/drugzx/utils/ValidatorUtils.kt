...
class ValidatorUtils  {
    ...
    companion object {
         ...
         */
        private fun getText(data: EditText?): String {
            var str = ""
            if (data is EditText) {
         ...
         */
        fun isValidName(data: EditText?, updateUI: Boolean = true): Boolean {
         ...
         */
        fun isValidEmail(data: EditText?, updateUI: Boolean = true): Boolean {
            val str = getText(data)
         ...
         */
        fun isValidPhone(data: EditText?, updateUI: Boolean = true): Boolean {
            val str = getText(data)
         ...
         */
        fun isValidPassword(data: EditText, updateUI: Boolean = true): Boolean {
            val str = getText(data)
            var valid = true
